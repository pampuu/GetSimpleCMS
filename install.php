...
?>
	...
	<h3><?php echo $site_full_name .' '. i18n_r('INSTALLATION'); ?></h3>
			...
			# OVERRIDE - Custom version used for the University of Newcastle for the course SENG1050 (Kieran.Molnar@newcastle.edu.au
			$verstatus = '1';
			...
			<?php
				if (version_compare(PHP_VERSION, "8.2", "<")) {
					$php_kill = "Invalid PHP version";
					echo 'PHP '.i18n_r('VERSION') .'</td><td><span class="ERRmsg" ><b>'. PHP_VERSION.'</b> - PHP 8.2 '.i18n_r('OR_GREATER_REQ') .' - '.i18n_r('ERROR') .'</span></td></tr>';
				} else {
